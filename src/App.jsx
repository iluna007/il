    ...
    <div className="app" data-theme={theme}>
      ...
      <div className="app-layout">
        <main className="cv-main" id="cv-content">
          <section id="intro" className="cv-intro">
            <Header lang={lang} />
          </section>
          ...
          <Section id="academic" title={s.academicExp}>
          ...
          <Section id="conferences" title={s.conferences}>
          ...
          <Section id="platforms" title={s.platforms}>
          ...
          <Section id="social" title={s.social}>
          ...
          <Section id="exhibitions" title={s.exhibitions}>
          ...
          <Section id="professional" title={s.professional}>
          ...
          <Section id="communities" title={s.communities}>
